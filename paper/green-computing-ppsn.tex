...
\title{Engineering greener evolutionary algorithms}
...
A tutorial with a very similar title and substantially the same topic in was
delivered in ACM SAC'25 Catania (Italy), it included the state of the art as
known back then. We have published since then several papers, and our
experimental techniques as well as methdologies are much more advanced right
now.
